# Handles using 'or' with ActiveRecord scopes.
#
# Monkey patch from https://gist.github.com/j-mcnally/250eaaceef234dd8971b
#
# It should be removed as soon as ActiveRecord handles them natively
module ActiveRecord
  module Querying
    delegate :or, :to => :all
  end
